...
Taskname: fast-web
Title: Make Web server Fast
Scope: The existing Electron app has a webserver, it is a simple web server, i wish to change the way it works to mirror the techniques shown in docs/development-notes/rules-for-webserver.md
