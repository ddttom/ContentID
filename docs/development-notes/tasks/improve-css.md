...
Scope: The CSS in this ;project seems over complicated, I would like a refactor that produces similar results, but more maintainable,
there are too many component, component-container, component-wrapper elements. Please check all html and css files, i do not want any in-line css
